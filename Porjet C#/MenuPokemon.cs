...
namespace Porjet_C_
{
    internal class MenuPokemon 
    {
        ...
        //    string menuPokemon = DisplayMenu(map, Pokemons, itemValue+1,lastState);
        //    FileReader newFileReader = new FileReader();
        //    newFileReader.setFile("..\\..\\..\\..\\ASCII\\Menu\\menuPokemontotal.txt");
        //    string finalMap = "";
        //    int nbDash = 0;
        //    for (int i = 0; i < menuPokemon.Length - 237; i++)
        //    {
